...
include("acess.php");
include("show_dept/show_english.php");
...
<head>
  ...
  <title>English Dept- Bootstrap Admin Template</title>
...
<a href="index.php" class="logo">Stock <span class="lite">Management  </span></a>
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-laptop"></i>english department</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="index.php">Home</a></li>
              <li><i class="fa fa-laptop"></i>Department Issue</li>
              <li><i class="fa fa-laptop"></i>English Dept</li>
            </ol>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-xl-6  col-md-6 col-sm-6 col-xs-12">
            <div class="info-box blue-bg">
              ...
              <div class="count"><?php echo $_SESSION ['english_entry'] ?></div>
          ...
          <div class="col-xl-6  col-md-6 col-sm-6 col-xs-12">
            <div class="info-box brown-bg">
              ...
              <div class="count"><?php echo $_SESSION ['english_quantity'] ?></div>
              ...
              <table class="table table-striped table-advance table-hover  ">
                <tbody>
                  <tr>
                    ...
                    <th class="text-center"><i class="icon_document_alt"></i> Department</th>
                    <th class="text-center"><i class="icon_document_alt"></i> Item Name</th>
                    <th class="text-center"><i class="icon_tags_alt"></i> Brand</th>
                    <th class="text-center"><i class="icon_calendar"></i> Issue Date</th>
                    <th class="text-center"><i class="icon_like"></i> Issue Quantity</th>
                    <th class="text-center"><i class="icon_like"></i>left Quantity</th>
                    <th class="text-center"><i class="icon_pencil"></i> Item Discription</th>
...
<?php
      ...
      $start=($page -1) * $limit;
      $query="SELECT * FROM issue_to_dept WHERE department='English Dept' LIMIT $start, $limit";
        ...
        while($row=mysqli_fetch_assoc($data))
            ...
            ?>  
               <tr class= text-center>
                      ...
                      <div class='btn-group'>
                            <a class='btn btn-info' href='english_update.php?s_n=<?php echo $row['serial_no']?>'>
                               <i class='icon_pencil-edit'></i>
                            </a>
                      </div>  
                  
                      <div class='btn-group'>
                          <a class='btn btn-danger' href='english_delete.php?s_n=<?php echo $row['serial_no']?>'>
...
?>
<!-- 
 & d=<?php echo $row['department']?> & i_n=<?php echo $row['item_name']?> & b=<?php echo $row['brand']?> & i_d=<?php echo $row['issue_date']?> & i_q=<?php echo $row['issue_quantity']?> & l_q=<?php echo $row['left_quantity']?> & i_d=<?php echo $row['item_discription']?> & c=<?php echo $row['condition']?> 
 -->
                </tbody>
              </table>
            </div>
...
<?php
$query1="SELECT * FROM issue_to_dept where department='English Dept' ";
...
echo' <div class="panel-body">';
  ...
  if($page>1){
  echo'<li><a href="english_dept.php?page='.($page-1).'">Prev</a></li>';
}
  ...
  { 
   ...
   echo' <li class="'.$active.'"><a href="english_dept.php?page='.$i.'">'.$i.'</a></li>';
  }
  if($total_page>$page){
  echo'<li><a href="english_dept.php?page='.($page+1).'">Next</a></li>';
}
