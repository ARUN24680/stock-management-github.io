          ...
          <div class="col-lg-12">
            <section class="panel">
              ...
              <div class="panel-body">
                <div class="form">
                  <form class="form-validate form-horizontal " method="POST" action="punjabi_dept.php">
                    ...
                    <div class="form-group">
                      <div class="col-lg-offset-2 col-lg-10">
                        ...
                        <button class="btn btn-danger" href="punjabi_dept.php" type="submit">Cancel</button>
                      </div>
                    </div>
                  </form>
                </div>
