...
<head>
  ...
  <title>it_update | Creative - Bootstrap 3 Responsive Admin Template</title>
                  ...
                  <form class="form-validate form-horizontal "   method="POST" action="it_dept.php">
                      ...
                      <div class="form-group">
                        ...
                        <?php
                            ...
                            $geted1="SELECT * FROM department";
                            $result1=mysqli_query($conn,$geted1) or die("query unsuccessful.");
                            ...
                            if($total1!="")
                              ...
                              echo"<select class='form-control'  name='department' required />";
                                ...
                                while($row1 = mysqli_fetch_assoc($result1)){
                                  ...
                                  echo "<option {$select} value='{$row1['id']}'>    {$row1['dept'] }  </option>";   
                    ...
                    <div class="form-group">
                      <div class="col-lg-offset-2 col-lg-10">
                        ...
                        <a class="btn btn-danger" href="it_dept.php"  type="button">cancel</a>
                      </div>
                    </div>
                  </form>
                </div>
