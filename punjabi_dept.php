...
include("acess.php");
include("show_dept/show_punjabi.php");
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
  ...
  <title>Punjabi Dept- Bootstrap Admin Template</title>
...
<a href="index.php" class="logo">Stock <span class="lite">Management  </span></a>
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-laptop"></i>punjabi department</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="index.php">Home</a></li>
              <li><i class="fa fa-laptop"></i>Department Issue</li>
              <li><i class="fa fa-laptop"></i>Punjabi Dept</li>
            </ol>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-xl-6 col-md-6 col-sm-6 col-xs-12">
            <div class="info-box blue-bg">
              ...
              <div class="count"> <?php echo $_SESSION ['punjabi_entry'] ?></div>
          ...
          <div class="col-xl-6 col-md-6 col-sm-6 col-xs-12">
            <div class="info-box brown-bg">
              ...
              <div class="count"> <?php echo $_SESSION ['punjabi_quantity'] ?> </div>
...
<?php
      ...
      $start=($page -1) * $limit;
      $query="SELECT * FROM issue_to_dept where department='Punjabi Dept' LIMIT $start, $limit";
        ...
        while($row=mysqli_fetch_assoc($data))
            ...
            ?>  
               ...
               <tr class= text-center>
                       ...
                       <td>
                      <div class='btn-group'>
                            <a class='btn btn-info' href='punjabi_update.php?s_n=<?php echo $row['serial_no']?> '>
                               <i class='icon_pencil-edit'></i>
                            </a>
                      </div>  
                  
                      <div class='btn-group'>
                          <a class='btn btn-danger' href='punjabi_delete.php?s_n=<?php echo $row['serial_no']?>'>
...
echo' <div class="panel-body">';
  ...
  if($page>1){
  echo'<li><a href="punjabi_dept.php?page='.($page-1).'">Prev</a></li>';
}
  ...
  { 
   ...
   echo' <li class="'.$active.'"><a href="punjabi_dept.php?page='.$i.'">'.$i.'</a></li>';
  }
  if($total_page>$page){
  echo'<li><a href="punjabi_dept.php?page='.($page+1).'">Next</a></li>';
}
