...
include("acess.php");
include("show_dept/show_math.php");
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
  ...
  <title>Mathematic Dept - Bootstrap Admin Template</title>
...
<a href="index.php" class="logo">Stock <span class="lite">Management  </span></a>
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-laptop"></i>mathematic department</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="index.php">Home</a></li>
              <li><i class="fa fa-laptop"></i>Department Issue</li>
              <li><i class="fa fa-laptop"></i>Mathematic Dept</li>
            </ol>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-xl-6  col-md-6 col-sm-6 col-xs-12">
            <div class="info-box blue-bg">
              ...
              <div class="count"><?php echo $_SESSION ['mathematic_entry'] ?></div>
          ...
          <div class="col-xl-6 col-md-6 col-sm-6 col-xs-12">
            <div class="info-box brown-bg">
              ...
              <div class="count"><?php echo $_SESSION ['mathematic_quantity'] ?></div>
              <div class="title">issueQuantity</div>
            </div>
            <!--/.info-box-->
          </div>
          <!--/.col-->
...
<?php
      ...
      $start=($page -1) * $limit;
      $query="SELECT * FROM issue_to_dept where department='Mathematic Dept' LIMIT $start, $limit";
            ...
            ?>  
               ...
               <tr class= text-center>
                       ...
                       <!--  & d=<?php echo $row['department']?> & i_n=<?php echo $row['item_name']?> & b=<?php echo $row['brand']?> & i_d=<?php echo $row['issue_date']?> & i_q=<?php echo $row['issue_quantity']?> & l_q=<?php echo $row['left_quantity']?> & i_d=<?php echo $row['item_discription']?> & c=<?php echo $row['condition']?> -->
                         <td>
                      <div class='btn-group'>
                            <a class='btn btn-info' href='math_update.php?s_n=<?php echo $row['serial_no']?> '>
                               <i class='icon_pencil-edit'></i>
                            </a>
                      </div>  
                   
                      <div class='btn-group'>
                          <a class='btn btn-danger' href='mathematic_delete.php?s_n=<?php echo $row['serial_no']?>'>
...
<?php
$query1="SELECT * FROM issue_to_dept where department='Jmc Dept' ";
...
if(mysqli_num_rows($data1)>0)
{
 ...
 echo' <div class="panel-body">';
  ...
  if($page>1){
  echo'<li><a href="mathematic_dept.php?page='.($page-1).'">Prev</a></li>';
}
  ...
  { 
   ...
   echo' <li class="'.$active.'"><a href="mathematic_dept.php?page='.$i.'">'.$i.'</a></li>';
  }
  if($total_page>$page){
  echo'<li><a href="mathematic_dept.php?page='.($page+1).'">Next</a></li>';
}
