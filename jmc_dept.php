...
include("acess.php");
include("show_dept/show_jmc.php");
...
<head>
  ...
  <title>Jmc- Bootstrap Admin Template</title>
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-laptop"></i>jmc department</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="index.php">Home</a></li>
              <li><i class="fa fa-laptop"></i>Department Issue</li>
              <li><i class="fa fa-laptop"></i>Jmc Dept</li>
            </ol>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-xl-6 col-md-6 col-sm-6 col-xs-12">
            <div class="info-box blue-bg">
              ...
              <div class="count"><?php echo $_SESSION ['jmc_entry'] ?></div>
          ...
          <div class="col-xl-6 col-md-6 col-sm-6 col-xs-12">
            <div class="info-box brown-bg">
              ...
              <div class="count"><?php echo $_SESSION ['jmc_quantity'] ?></div>
...
<?php
      ...
      $start=($page -1) * $limit;
      $query="SELECT * FROM issue_to_dept where department='Jmc Dept' LIMIT $start, $limit";
 ...
 -->
                      ...
                      <div class='btn-group'>
                            <a class='btn btn-info' href='jmc_update.php?s_n=<?php echo $row['serial_no']?>'>
                               <i class='icon_pencil-edit'></i>
                            </a>
                      </div>  
                  
                      <div class='btn-group'>
                          <a class='btn btn-danger' href='jmc_delete.php?s_n=<?php echo $row['serial_no']?>'>
...
echo' <div class="panel-body">';
  ...
  if($page>1){
  echo'<li><a href="jmc_dept.php?page='.($page-1).'">Prev</a></li>';
}
  ...
  { 
   ...
   echo' <li class="'.$active.'"><a href="jmc_dept.php?page='.$i.'">'.$i.'</a></li>';
  }
  if($total_page>$page){
  echo'<li><a href="jmc_dept.php?page='.($page+1).'">Next</a></li>';
}
